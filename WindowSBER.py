...
class StockMonitor:
    """
    Основной класс приложения для мониторинга акций SBER.
    ...
    def __init__(self, root):
        ...
        self.root = root
        self.root.title("Монитор акций SBER")
    ...
    def show_about(self):
        ...
        messagebox.showinfo("О программе", 
                           "Монитор акций SBER\n\n"
                           "Версия 1.0\n"
                           "Приложение для отслеживания акций Сбербанка\n"
    ...
    def create_widgets(self):
        ...
        # Заголовок
        title_label = ttk.Label(main_frame, text="График акций Сбербанка (SBER)", 
                               font=("Arial", 16, "bold"))
    ...
    def load_daily_data(self):
        ...
        try:
            ...
            with open('sber_daily_data.json', 'r') as f:
                ...
                if saved_date.date() == today:
                    ...
                    print("Загружены сохраненные данные за сегодня")
            ...
            print("Файл с сохраненными данными не найден, создаем новые данные")
    ...
    def create_initial_chart_data(self):
        ...
        print("Созданы начальные данные графика с предыдущими ценами")
    ...
    def save_daily_data(self):
        ...
        try:
            ...
            with open('sber_daily_data.json', 'w') as f:
    ...
    def update_interface(self, data):
        ...
        price_text = f"Цена: {price:.2f} руб{source_info}"
    ...
    def export_data(self):
        ...
        try:
            if self.chart_manager.daily_data:
                ...
                filename = f"sber_daily_data_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
